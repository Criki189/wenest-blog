---
title: >-
  How to check if a power point is safe (and the 5 warning signs you should
  never ignore)
slug: how-to-check-if-a-power-point-is-safe
description: >-
  Learn how to do a power point safety check at home — plus the 5 warning signs
  that mean you need a licensed electrician today.
primary_keyword: power point safety check
secondary_keywords:
  - faulty power point signs
  - power outlet sparking Australia
...
internal_links:
  ...
  - /pricing
  - /blog/who-to-hire-when-moving-house-sydney-tradesperson-checklist
schema_type: Article
faq: true
faq_items:
  - question: How do I know if a power point is dangerous?
    answer: >-
      The clearest signs are warmth or heat when nothing is plugged in, scorch
      marks or discolouration around the face plate, a burning plastic smell,
      buzzing or crackling sounds, and sparks when you insert a plug. Any one of
      these means stop using the outlet immediately and call a licensed
      electrician. Don't wait to see if it gets worse — it will.
  - question: Is it safe to use a power point that sparks?
    answer: >-
      A tiny, brief spark when you plug something in can be normal — it's just
      the circuit energising. Sustained sparking, loud popping, or sparks that
      happen when nothing is being plugged in are not normal. In Australia,
      these are treated as electrical faults and must be inspected by a licensed
      electrician before the outlet is used again.
  - question: Can a faulty power point cause a house fire in Australia?
    answer: >-
      Yes. Electrical faults — including degraded wiring, loose terminals, and
      overloaded circuits — are among the leading causes of house fires in NSW.
      A power point that runs warm or shows scorch marks is showing you early
      signs of the same conditions that start fires inside wall cavities, often
      while the household is asleep.
  - question: Who do I call to check my power points in NSW?
    answer: >-
      You need a licensed electrician. In NSW, all electrical work — including
      inspecting, replacing, or repairing power points — must be performed by
      someone holding a valid electrical licence issued by NSW Fair Trading. You
      can verify a tradesperson's licence at fairtrading.nsw.gov.au before they
      start work.
  - question: How much does it cost to replace a power point in Sydney?
    answer: >-
      A straightforward single-outlet replacement typically runs around $150 to
      $280 plus GST, depending on the electrician and whether the wiring behind
      the wall needs attention. If the fault has caused damage to surrounding
      wiring, costs climb — we've seen quotes from $180 for a clean swap to well
      over $600 when the wall cavity needs investigation.
...
Let's be direct about the limits first. In NSW, you cannot open a power point, touch any wiring, or replace any component yourself. That is licensed electrical work under the [Electricity (Consumer Safety) Act 2004](https://www.fairtrading.nsw.gov.au/trades-and-businesses/licensing/electrical-licensing), and doing it unlicensed voids your home insurance and creates real liability.
...
If you're buying or have recently bought an older Sydney home, the [tradesperson checklist we put together for moving house](/blog/who-to-hire-when-moving-house-sydney-tradesperson-checklist) covers electrical inspection as one of the first things to arrange — worth reading before you unpack.
...
*This article is general guidance only. Any electrical work in NSW must be performed by a licensed tradesperson. You can verify an electrician's licence at [NSW Fair Trading](https://www.fairtrading.nsw.gov.au/).*

---

If you'd rather not be the one googling electricians at 9 PM while your switchboard is half-isolated and the kids need the TV — that's exactly what we handle. [Wenest members](/pricing) get a licensed electrician coordinated without the calls, the callbacks, or the waiting.
