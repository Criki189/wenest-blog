---
title: 'Who to hire when you move house in Sydney: the complete tradesperson checklist'
slug: who-to-hire-when-moving-house-sydney-tradesperson-checklist
description: >-
  Know exactly who to hire when moving house in Sydney — the right trades, the
  right order, and what legally needs a licensed pro in NSW.
primary_keyword: who to hire when moving house Sydney
secondary_keywords:
  - moving house tradesperson checklist Sydney
  - trades needed when moving into new home
  - pre-move-in home checks Sydney
...
faq_items:
  - question: >-
      Do I need a licensed electrician to check my switchboard when moving house
      in Sydney?
    answer: >-
      Yes. Any work on your switchboard, including safety-switch testing and
      installation, must be carried out by a licensed electrician in NSW. A
      general handyman cannot legally touch it. You can verify a tradesperson's
      electrical licence through NSW Fair Trading before booking.
  - question: How much does it cost to rekey a house in Sydney?
    answer: >-
      Rekeying a standard three-bedroom Sydney home typically runs around $180
      to $280 plus GST, depending on the number of cylinders and the locksmith's
      call-out fee. Full lock replacement costs more — budget around $120 to
      $180 per lock for mid-range hardware. Always use a licensed locksmith for
      new homes.
  - question: Do I need a pest inspection when moving into a new home in Sydney?
    answer: >-
      It's strongly advisable, especially in older suburbs or homes with timber
      floors and framing. A combined building and pest inspection before
      settlement is standard, but a standalone pest inspection at move-in is
      worth doing if you didn't get one — termite activity can develop quickly
      in Sydney's climate.
  - question: What trades do I need when moving out of a rental in Sydney?
    answer: >-
      For a rental vacate in Sydney, you'll typically need a bond cleaner, a
      carpet cleaner (if carpeted), a pest controller for flea treatment if you
      had pets, and a handyman for any minor repairs like wall patching or blind
      replacement. Electrical and plumbing repairs must go to licensed trades.
  - question: Can I do my own plumbing when moving house in NSW?
    answer: >-
      Not for most work. In NSW, any plumbing that connects to the water supply
      or drainage system must be done by a licensed plumber. That includes
...
cover_image_alt: >-
  ...
  hallway
cover_image_prompt: moving boxes hallway Sydney home front door keys
author: Wenest
...
If you've ever had a circuit trip unexpectedly in a new home, [read our breakdown on why power keeps tripping](/blog/power-keeps-tripping) — it covers what the causes usually are and when to stop resetting the breaker yourself.
...
- Gas fitters (separate licence from plumbing in some cases — check via [NSW Fair Trading](https://www.fairtrading.nsw.gov.au/))
