...
#   3. install the launchd cron so it keeps publishing on its own (Mon/Wed/Fri, 10:00).
#
...
echo "4/4 · Instalando el cron (lunes, miércoles y viernes, 10:00)…"
...
echo "   · A partir de ahora se publica SOLO los lunes, miércoles y viernes a las 10:00."
